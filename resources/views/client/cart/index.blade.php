                                            ...
                                            <td>
                                                <div class="relative flex items-center">
                                                    ...
                                                    <input type="text" id="counter-input-{{ $key ?? '' }}"
                                                        ...
                                                        class="input-quantity flex-shrink-0 text-gray-900 dark:text-black border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center"
